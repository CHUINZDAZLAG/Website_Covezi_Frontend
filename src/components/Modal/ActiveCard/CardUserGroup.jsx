...
function CardUserGroup({ cardMemberIds = [], onUpdateCardMember }) {
  ...
  // Get activeBoard from Redux to get all info of members by FE_allUsers
  ...
  const handleUpdateCardMembers = (user) => {
    // Create incomingMemberInfo variable to send to BE with 2 field userId and action removing or add to Card
