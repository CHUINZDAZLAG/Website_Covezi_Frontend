...
import { updateCardInDetailAPI } from '~/apis'
...
function ActiveCard() {
  ...
  // Dont use State to check open Modal, it will be checked in isShowModalActiveCard
  ...
  // Function use for any case update props of Card
  const callApiUpdateCard = async (updateData) => {
    const updatedCard = await updateCardInDetailAPI(activeCard._id, updateData)

    // Step 1: update card active in recent modal
  ...
  // Use async await for child component CardActivitySection wait and if success then clear input comment
        ...
        <Grid container spacing={2} sx={{ mb: 3 }}>
          ...
          <Grid xs={12} sm={3}>
            ...
            <Stack direction="column" spacing={1}>
              ...
              {/* Show Join button when user is not a member of Card
              Always ADD when click Join button */}
