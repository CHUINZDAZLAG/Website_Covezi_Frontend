...
function Boards() {
  ...
  useEffect(() => {
    ...
    // uselocation của react-router-dom cũng thay đổi theo, đồng nghiệp hàm useffect sẽ chạy lại và fetch lại API
    // theo đúng page mới vì cái location.search đã nằm trong dependencies của useffect
