...
export const activeCardSlice = createSlice({
  ...
  initialState,
  reducers: {
    // Lưu ý luôn là ở đây cần cập nhập nhọn cho function trong reducer cho dù code bên trong chỉ có 1
    ...
    updateCurrentActiveCard: (state, action) => {
      const fullCard = action.payload // action.payload là chuẩn đặt tên nhận dữ liệu vào reducer, ở đây
