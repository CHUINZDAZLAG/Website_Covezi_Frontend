...
export const notificationsSlice = createSlice({
  ...
  reducers: {
    ...
    // Add new notification to to the beginning of the array
...
// Cái file này tên là notificationsSlice NHƯNG chúng ta sẽ export một thứ tên là Reducer, mọi người lưu
// ý :D
